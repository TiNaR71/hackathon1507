      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body filter">
            <div class="row mb-4 selectrow">
              <div class="col-4 select-box_box"  style="min-width: 326px">
              ...
              <div class="col-8 select-box_box" style="min-width: 726px">
    ...
    <div id="objects" v-if="foundObjects.length">
      ...
      <div class="object card col-4 mt-4" v-for="object in foundObjects" :key="object.id" >
        <div class="row">
          ...
          <div class="col-8 ">
            <div class="id pointer" @click="openObject(object)">ID {{object.external_id}}</div>
            <div class="tag">Свободно</div>
            <label class="pointer" @click="openObject(object)">Объект {{ object.object }}</label>
          ...
          <div class="col-12 pt-4">
            <div class="buttons">
              <div class="button bron pointer" @click="openObject(object)">Забронировать</div>
